	...
	return (function(a) {
		...
		function e() {
			...
			if (t.tagName === "TEXTAREA" || (t.tagName ===
				"INPUT" && t.getAttribute("type") ===
				"text" || t.getAttribute("type") ===
				"email" || t.getAttribute("type") ===
				"password")) {
		...
		function i() {
			...
			for (var q = 0; q < n.length; ++q) {
				...
				a.fillStyle = r.color;
				a.fillRect(Math.round(r.x - 1.5), Math.round(r.y -
					1.5), 3, 3)
			}
		}
		requestAnimationFrame(i);
		...
		(function() {
			var d = ["direction", "boxSizing", "width",
				"height", "overflowX", "overflowY",
				"borderTopWidth", "borderRightWidth",
				"borderBottomWidth", "borderLeftWidth",
				"borderStyle", "paddingTop",
				"paddingRight", "paddingBottom",
				"paddingLeft", "fontStyle",
			...
			function c(k, l, o) {
				...
				var j = window.getComputedStyle ?
					getComputedStyle(k) : k.currentStyle;
				...
				f.appendChild(n);
				var m = {
					top: n.offsetTop + parseInt(j[
						"borderTopWidth"]),
					left: n.offsetLeft + parseInt(j[
						"borderLeftWidth"])
				};
				if (h) {
			...
			if (typeof b != "undefined" && typeof b.exports !=
				"undefined") {
				b.exports = c
			} else {
