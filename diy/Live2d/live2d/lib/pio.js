    ...
    var action = {
        ...
        buttons: function () {
            ...
            elements.info.onclick = function () {
                window.open(prop.content.link || "https://t.me/piaomiaoxu");
            };
            elements.info.onmouseover = function () {
                modules.render("想了解更多关于我的信息吗？加入我们吧！");
            };
            ...
            if (prop.night) {
                elements.night.onclick = function () {
                    modules.dark();
                    eval(prop.night[darkstr.data]);
                    // console.log("data: " + darkstr.data);
                };
                elements.night.onmouseover = function () {
                prop.content.night && prop.content.night[darkstr.data] ? modules.render(prop.content.night[darkstr.data]) : modules.render("夜间点击这里可以保护眼睛呢");
                };
                 current.menu.appendChild(elements.night);
            }
